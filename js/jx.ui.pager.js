Jx().$package(function(J){
    var $D = J.dom,
        $E = J.event;
	J.ui = J.ui || {};
	J.ui.Pager=new J.Class({
		init:function(pageContainer,count,pageSize,curPage,pageHandle,prevCount,nextCount,lastCount,firstCount){
		...
		resetPager:function(_count,_pageSize,_curPage){
			var curPage=this.curPage=_curPage===undefined?this.curPage:_curPage;
