...
Jx().$package(function(J){
    ...
    /**
     * 通过html生成dom节点
     * Generates an HTML element (maybo some) form the html code given
     * @author weberpan
     * 
     * @memberOf dom
     * 
     * @param html {string} the html to generate node(s)
     * @return {HTMLElement} the generated node
     *      or {array} the generated node list
     */
    xnode = function(html){
    ...
    */
     ...
     */
    createStyleNode = function(styleText, id, doc){
        ...
        $D.getDocHead(doc).appendChild(styleNode);
        return styleNode;
    };
	...
	//获取当前浏览器支持的transition属性
	var transition = function() {
		var styles = document.createElement('a').style,
			props = ['webkitTransition', 'MozTransition', 'OTransition', 'msTransition', 'Transition'];
	...
	$D.setTransform = setTransform;
	$D.getTransform = getTransform;
